...
package jakir.comHoron;
// Frame for the Sketcher application
import static jakir.comHoron.SketcherConstants.CIRCLE;
import static jakir.comHoron.SketcherConstants.CURVE;
import static jakir.comHoron.SketcherConstants.DEFAULT_ELEMENT_COLOR;
import static jakir.comHoron.SketcherConstants.DEFAULT_ELEMENT_TYPE;
import static jakir.comHoron.SketcherConstants.LINE;
import static jakir.comHoron.SketcherConstants.RECTANGLE;
...
public class SketchFrame extends JFrame {
  ...
  //  openAction.putValue(Action.SMALL_ICON, new ImageIcon (getClass().getResource("/jakir/img/Save.gif"))); 
      openAction.putValue(Action.SMALL_ICON, new ImageIcon (getClass().getResource("/jakir/img/Save.gif")));
